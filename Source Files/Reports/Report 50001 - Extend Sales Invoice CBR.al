report 50001 "Extend Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesInvoiceNA.rdlc';
    Caption = 'Sales - Invoice CBR';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShiptoCode_SIH; "Sales Invoice Header"."Ship-to Code")
                    {
                    }
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(TLExpense; TempSalesInvoiceLine."TL Income/Expense Line CBR")
                        {
                        }
