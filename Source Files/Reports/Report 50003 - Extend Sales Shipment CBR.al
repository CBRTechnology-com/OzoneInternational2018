report 50003 "Extend Sales Shipment NA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesShipmentNA.rdlc';
    Caption = 'Sales Shipment CBR';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShiptoCode_SSH; "Sales Shipment Header"."Ship-to Code")
                    {
                    }
    ...
    var
        ...
        PackageTrackingNoText: Text[100];
        PackageTrackingNoLabel: Text[100];
