report 50006 "Extend Item Cost & Price List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ItemCostandPriceList.rdlc';
    Caption = 'Item Cost and Price List CBR';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(Item_ManufacturerItemNo; "Manufacturer Item No. CBR")
            {
            }
            column(Item_VendorItemNoCaption; fieldcaption("Vendor Item No."))
            {
            }
            column(Item_ManufacturerItemNoCaption; fieldcaption("Manufacturer Item No. CBR"))
            {
            }
    ...
    begin
        ...
        //GA00
        ExcelBuf.AddColumn(Item.FIELDCAPTION("Vendor Item No."), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.AddColumn(Item.FIELDCAPTION("Manufacturer Item No. CBR"), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        //GA00 end
    ...
    begin
        ...
        if UseSKU and Item."Stockkeeping Unit Exists" then begin
            ...
            //GA00
            ExcelBuf.AddColumn(Item."Vendor Item No.", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
            ExcelBuf.AddColumn(Item."Manufacturer Item No. CBR", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
            //GA00 end
            ExcelBuf.AddColumn(Item."Base Unit of Measure", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text);
