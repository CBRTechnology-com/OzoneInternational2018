report 50004 "Extend Transfer Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TransferOrder.rdlc';
    Caption = 'Transfer Order CBR';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Transfer Line"; "Transfer Line")
                    {
                        ...
                        //column(ProductGroupCode;transferline."Product Group Code")
                        //{
                        //}
                        column(ItemCatCode; ParentItemCategory)
                        {
                        }
                        ...
                        begin
                            ...
                            ///AP>>>
                            IF "Transfer Line"."Item Category Code" <> '' THEN BEGIN
                                IF ItemCat.GET("Transfer Line"."Item Category Code") THEN
                                    ParentItemCategory := ItemCat.Code;
